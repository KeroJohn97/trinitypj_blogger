  ...
  (
        ...
        >
          <div className="grid grid-cols-[minmax(auto,8rem)_auto_1fr] items-start px-4">
            ...
            <div className="mx-3 flex flex-col items-center justify-start gap-y-2">
              ...
              {showConnector && <div className="bg-muted h-full w-0.5 animate-pulse" />}
            </div>
    ...
    if (error) {
      return (
        <motion.li
          ref={ref}
          className={cn(commonClassName, "border-destructive/50 bg-destructive/10 border")}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          role="alert"
          {...props}
  ...
  ({ className, date, format, children, ...props }, ref) => {
    ...
    return (
      <time
        ...
        className={cn("text-muted-foreground text-sm font-medium tracking-tight", className)}
        {...props}
      >
  ...
  <div
    ...
    className={cn(
      "w-0.5",
      {
        ...
        "from-primary to-muted bg-gradient-to-b": !color && status === "in-progress",
      },
      className
    )}
    {...props}
...
const TimelineTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, children, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("text-secondary-foreground leading-none font-semibold tracking-tight", className)}
      {...props}
    >
      {children}
    </h3>
...
const TimelineDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-muted-foreground max-w-sm text-sm", className)} {...props} />
  )
)
TimelineDescription.displayName = "TimelineDescription"

const TimelineContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn("flex flex-col gap-2 pl-2", className)} {...props} />
)
